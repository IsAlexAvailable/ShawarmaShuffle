...
public abstract class Furniture extends Entity {
    ...
    public boolean hasCollision(Character c) {  //  TODO is this the best logic???
        ...
        int obstacleX1 = hitbox.getX1(), obstacleY1 = hitbox.getY1(), obstacleX2 = hitbox.getX2(), obstacleY2 = hitbox.getY2();
        ...
        switch (characterDirection) {
            case LEFT:
                ...
                return 
                    ...
                    (characterY2 >= obstacleY1) &&
                    (characterY2 <= obstacleY2));
            case RIGHT:
                ...
                return
                    ...
                    (characterY2 <= obstacleY2));
            case UP:
                futureCharaY = characterY2 - characterDelta;
                return
                    ((futureCharaY >= obstacleY1) &&
                    (futureCharaY <= obstacleY2) &&      //  bottom left character corner test
                    (characterX1 >= obstacleX1) &&
                    (characterX1 <= obstacleX2)) ||
                    ((characterX2 <= obstacleX2) &&
                    (characterX2 >= obstacleX1) &&       // bottom right character corner test
                    (futureCharaY <= obstacleY2) &&
                    (futureCharaY >= obstacleY1));
            case DOWN:
                futureCharaY3 = characterY2 + characterDelta;
                return
                    ((futureCharaY3 <= obstacleY2) &&
                    (futureCharaY3 >= obstacleY1) &&      // bottom left character corner test
                    (characterX1 >= obstacleX1) &&
                    (characterX1 <= obstacleX2)) || 
                    ((futureCharaY3 <= obstacleY2) &&
                    (futureCharaY3 >= obstacleY1) &&      // bottom right character corner test
                    (characterX2 >= obstacleX1) &&
                    (characterX2 <= obstacleX2));
            case NORTHWEST:
                futureCharaX1 = characterX1 - characterDeltaDiag;
                futureCharaY3 = characterY2 - characterDeltaDiag;
                return 
                    ((futureCharaX1 <= obstacleX2) &&
                    (futureCharaX1 >= obstacleX1) &&       // bottom left character corner test
